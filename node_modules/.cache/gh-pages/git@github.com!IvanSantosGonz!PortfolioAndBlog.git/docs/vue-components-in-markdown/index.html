...
<span style="color:#89DDFF;">}</span></code></pre></div></div></div></main><footer class="bg-green-700 text-white"><div class="container mx-auto flex flex-col lg:flex-row items-center justify-between py-8"><div class="mb-8 lg:mb-0"><div>Copyright 2020. All rights reserved.</div><div><a href="/rss.xml" class="text-white hover:text-gray-400 font-normal">RSS Feed</a> |
    ...
    <script>window.__INITIAL_STATE__={"data":{"documentation":{"title":"Vue Components in Markdown","excerpt":"An example markdown page that has Vue Components inside of it!"}},"context":{}};(function(){var s;(s=document.currentScript||document.scripts[document.scripts.length-1]).parentNode.removeChild(s);}());</script><script src="/assets/js/app.efe258bf.js" defer></script><script src="/assets/js/page--src-templates-documentation-vue.7b730e87.js" defer></script><script src="/assets/js/vue-remark--docs-vue-components-in-markdown-md.a1d2996b.js" defer></script>
  </body>
</html>
