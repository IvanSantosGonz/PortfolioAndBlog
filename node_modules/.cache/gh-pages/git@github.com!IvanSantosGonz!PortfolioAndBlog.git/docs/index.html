...
<html data-html-server-rendered="true" lang="en" data-vue-tag="%7B%22lang%22:%7B%22ssr%22:%22en%22%7D%7D">
  ...
  <body >
    ...
    <script>window.__INITIAL_STATE__={"data":{"docs":{"edges":[{"node":{"id":"d3a8341f72283e39090b6787c7ecbcc4","path":"\u002Fdocs\u002Fvue-components-in-markdown\u002F","title":"Vue Components in Markdown","excerpt":"An example markdown page that has Vue Components inside of it!"}}]}},"context":{}};(function(){var s;(s=document.currentScript||document.scripts[document.scripts.length-1]).parentNode.removeChild(s);}());</script><script src="/assets/js/app.efe258bf.js" defer></script><script src="/assets/js/page--src-pages-docs-vue.931758f7.js" defer></script>
  </body>
</html>
