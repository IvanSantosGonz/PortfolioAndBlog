...
<html data-html-server-rendered="true" lang="en" data-vue-tag="%7B%22lang%22:%7B%22ssr%22:%22en%22%7D%7D">
  ...
  <body >
    ...
    <script>window.__INITIAL_STATE__={"data":{"tag":{"title":"Refactoring","belongsTo":{"totalCount":1,"pageInfo":{"totalPages":1,"currentPage":1},"edges":[{"node":{"title":"Refrescando Principios SOLID","timeToRead":5,"date":"May 7, 2020","path":"\u002Fsolid-principles","summary":"En este artículo haremos un repaso de los principios Solid a través de diferentes ejemplos de código","tags":[{"title":"Clean Code"},{"title":"Refactoring"}]}}]}}},"context":{}};(function(){var s;(s=document.currentScript||document.scripts[document.scripts.length-1]).parentNode.removeChild(s);}());</script><script src="/assets/js/app.efe258bf.js" defer></script><script src="/assets/js/page--src-templates-tag-vue.6e18ee1a.js" defer></script>
  </body>
</html>
