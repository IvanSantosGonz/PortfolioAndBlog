...
<pre class="shiki" style="background-color: #292D3E"><code><span style="color: #C792EA">public</span><span style="color: #FFFFFF"> </span><span style="color: #F78C6C">class</span><span style="color: #FFFFFF"> </span><span style="color: #FFCB6B">Person</span><span style="color: #FFFFFF"> </span><span style="color: #89DDFF">{</span>
<span style="color: #FFFFFF">   </span><span style="color: #C792EA">private</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">string</span><span style="color: #FFFFFF"> </span><span style="color: #FFCB6B">name</span><span style="color: #89DDFF">;</span>
<span style="color: #FFFFFF">   </span><span style="color: #C792EA">private</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">int</span><span style="color: #FFFFFF"> </span><span style="color: #FFCB6B">bornDay</span><span style="color: #89DDFF">;</span>
<span style="color: #FFFFFF">   </span><span style="color: #C792EA">private</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">int</span><span style="color: #FFFFFF"> </span><span style="color: #FFCB6B">bornMonth</span><span style="color: #89DDFF">;</span>
<span style="color: #FFFFFF">   </span><span style="color: #C792EA">private</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">int</span><span style="color: #FFFFFF"> </span><span style="color: #FFCB6B">bornYear</span><span style="color: #89DDFF">;</span>

<span style="color: #FFFFFF">   </span><span style="color: #C792EA">public</span><span style="color: #FFFFFF"> </span><span style="color: #82AAFF">Person</span><span style="color: #89DDFF">(</span><span style="color: #C792EA">string</span><span style="color: #FFFFFF"> </span><span style="color: #FFCB6B">name</span><span style="color: #89DDFF">,</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">int</span><span style="color: #FFFFFF"> </span><span style="color: #FFCB6B">bornDay</span><span style="color: #89DDFF">,</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">int</span><span style="color: #FFFFFF"> </span><span style="color: #FFCB6B">bornMonth</span><span style="color: #89DDFF">,</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">int</span><span style="color: #FFFFFF"> </span><span style="color: #FFCB6B">bornYear</span><span style="color: #89DDFF">)</span><span style="color: #FFFFFF"> </span><span style="color: #89DDFF">{</span>
<span style="color: #FFFFFF">      </span><span style="color: #F78C6C">this</span><span style="color: #89DDFF">.</span><span style="color: #A6ACCD">name</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">=</span><span style="color: #FFFFFF"> </span><span style="color: #A6ACCD">name</span><span style="color: #89DDFF">;</span>
<span style="color: #FFFFFF">      </span><span style="color: #F78C6C">this</span><span style="color: #89DDFF">.</span><span style="color: #A6ACCD">bornDay</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">=</span><span style="color: #FFFFFF"> </span><span style="color: #A6ACCD">bornDay</span><span style="color: #89DDFF">;</span>
<span style="color: #FFFFFF">      </span><span style="color: #F78C6C">this</span><span style="color: #89DDFF">.</span><span style="color: #A6ACCD">bornMonth</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">=</span><span style="color: #FFFFFF"> </span><span style="color: #A6ACCD">bornMonth</span><span style="color: #89DDFF">;</span>
<span style="color: #FFFFFF">      </span><span style="color: #F78C6C">this</span><span style="color: #89DDFF">.</span><span style="color: #A6ACCD">bornYear</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">=</span><span style="color: #FFFFFF"> </span><span style="color: #A6ACCD">bornYear</span><span style="color: #89DDFF">;</span>
<span style="color: #FFFFFF">   </span><span style="color: #89DDFF">}</span>

<span style="color: #FFFFFF">   </span><span style="color: #C792EA">public</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">void</span><span style="color: #FFFFFF"> </span><span style="color: #82AAFF">printAge</span><span style="color: #89DDFF">()</span><span style="color: #FFFFFF"> </span><span style="color: #89DDFF">{</span>
<span style="color: #FFFFFF">      </span><span style="color: #89DDFF">if</span><span style="color: #FFFFFF"> </span><span style="color: #89DDFF">(</span><span style="color: #A6ACCD">nowMonth</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">&gt;=</span><span style="color: #FFFFFF"> </span><span style="color: #A6ACCD">bornMonth</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">&&</span><span style="color: #FFFFFF"> </span><span style="color: #A6ACCD">nowDay</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">&gt;=</span><span style="color: #FFFFFF"> </span><span style="color: #A6ACCD">bornDay</span><span style="color: #89DDFF">)</span><span style="color: #FFFFFF"> </span><span style="color: #89DDFF">{</span>
<span style="color: #FFFFFF">         </span><span style="color: #A6ACCD">Console</span><span style="color: #89DDFF">.</span><span style="color: #82AAFF">WriteLine</span><span style="color: #89DDFF">(</span><span style="color: #89DDFF">"</span><span style="color: #C3E88D">Person has </span><span style="color: #89DDFF">"</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">+</span><span style="color: #FFFFFF"> </span><span style="color: #A6ACCD">nowYear</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">-</span><span style="color: #FFFFFF"> </span><span style="color: #A6ACCD">bornYear</span><span style="color: #89DDFF">);</span>
<span style="color: #FFFFFF">      </span><span style="color: #89DDFF">}</span><span style="color: #FFFFFF">      </span>
<span style="color: #FFFFFF">      </span><span style="color: #89DDFF">else</span><span style="color: #FFFFFF"> </span><span style="color: #89DDFF">{</span>
<span style="color: #FFFFFF">         </span><span style="color: #A6ACCD">Console</span><span style="color: #89DDFF">.</span><span style="color: #82AAFF">WriteLine</span><span style="color: #89DDFF">(</span><span style="color: #89DDFF">"</span><span style="color: #C3E88D">Person has </span><span style="color: #89DDFF">"</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">+</span><span style="color: #FFFFFF"> </span><span style="color: #A6ACCD">nowYear</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">-</span><span style="color: #FFFFFF"> </span><span style="color: #A6ACCD">bornYear</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">-</span><span style="color: #FFFFFF"> </span><span style="color: #F78C6C">1</span><span style="color: #89DDFF">);</span>
<span style="color: #FFFFFF">      </span><span style="color: #89DDFF">}</span>
<span style="color: #FFFFFF">   </span><span style="color: #89DDFF">}</span>
<span style="color: #89DDFF">}</span>

<span style="color: #F78C6C">class</span><span style="color: #FFFFFF"> </span><span style="color: #FFCB6B">Init</span><span style="color: #FFFFFF"> </span><span style="color: #89DDFF">{</span>
<span style="color: #FFFFFF">   </span><span style="color: #C792EA">private</span><span style="color: #FFFFFF"> </span><span style="color: #82AAFF">Init</span><span style="color: #89DDFF">()</span><span style="color: #FFFFFF"> </span><span style="color: #89DDFF">{</span>
<span style="color: #FFFFFF">      </span><span style="color: #F78C6C">var</span><span style="color: #FFFFFF"> </span><span style="color: #FFCB6B">person</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">=</span><span style="color: #FFFFFF"> </span><span style="color: #F78C6C">new</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">Person</span><span style="color: #89DDFF">(</span><span style="color: #89DDFF">"</span><span style="color: #C3E88D">Iván</span><span style="color: #89DDFF">"</span><span style="color: #89DDFF">,</span><span style="color: #FFFFFF"> </span><span style="color: #F78C6C">1</span><span style="color: #89DDFF">,</span><span style="color: #FFFFFF"> </span><span style="color: #F78C6C">1</span><span style="color: #89DDFF">,</span><span style="color: #FFFFFF"> </span><span style="color: #F78C6C">1990</span><span style="color: #89DDFF">);</span>
<span style="color: #FFFFFF">      </span><span style="color: #A6ACCD">person</span><span style="color: #89DDFF">.</span><span style="color: #82AAFF">PrintAge</span><span style="color: #89DDFF">();</span>
<span style="color: #FFFFFF">   </span><span style="color: #89DDFF">}</span>
...
<span style="color: #FFFFFF">   </span><span style="color: #C792EA">public</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">int</span><span style="color: #FFFFFF"> </span><span style="color: #82AAFF">getAge</span><span style="color: #89DDFF">()</span><span style="color: #FFFFFF"> </span><span style="color: #89DDFF">{</span>
<span style="color: #FFFFFF">      </span><span style="color: #89DDFF">if</span><span style="color: #FFFFFF"> </span><span style="color: #89DDFF">(</span><span style="color: #A6ACCD">nowMonth</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">&gt;=</span><span style="color: #FFFFFF"> </span><span style="color: #A6ACCD">bornMonth</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">&&</span><span style="color: #FFFFFF"> </span><span style="color: #A6ACCD">nowDay</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">&gt;=</span><span style="color: #FFFFFF"> </span><span style="color: #A6ACCD">bornDay</span><span style="color: #89DDFF">)</span><span style="color: #FFFFFF"> </span><span style="color: #89DDFF">{</span>
<span style="color: #FFFFFF">         </span><span style="color: #89DDFF">return</span><span style="color: #89DDFF">(</span><span style="color: #A6ACCD">nowYear</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">-</span><span style="color: #FFFFFF"> </span><span style="color: #A6ACCD">bornYear</span><span style="color: #89DDFF">);</span>
<span style="color: #FFFFFF">      </span><span style="color: #89DDFF">}</span>
<span style="color: #FFFFFF">      </span><span style="color: #89DDFF">else</span><span style="color: #FFFFFF"> </span><span style="color: #89DDFF">{</span>
<span style="color: #FFFFFF">         </span><span style="color: #89DDFF">return</span><span style="color: #FFFFFF"> </span><span style="color: #89DDFF">(</span><span style="color: #A6ACCD">nowYear</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">-</span><span style="color: #FFFFFF"> </span><span style="color: #A6ACCD">bornYear</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">-</span><span style="color: #FFFFFF"> </span><span style="color: #F78C6C">1</span><span style="color: #89DDFF">);</span>
<span style="color: #FFFFFF">      </span><span style="color: #89DDFF">}</span>
<span style="color: #FFFFFF">   </span><span style="color: #89DDFF">}</span>
<span style="color: #89DDFF">}</span>
...
<span style="color: #FFFFFF">   </span><span style="color: #C792EA">private</span><span style="color: #FFFFFF"> </span><span style="color: #82AAFF">Init</span><span style="color: #89DDFF">()</span><span style="color: #FFFFFF"> </span><span style="color: #89DDFF">{</span>
<span style="color: #FFFFFF">      </span><span style="color: #F78C6C">var</span><span style="color: #FFFFFF"> </span><span style="color: #FFCB6B">person</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">=</span><span style="color: #FFFFFF"> </span><span style="color: #F78C6C">new</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">Person</span><span style="color: #89DDFF">(</span><span style="color: #89DDFF">"</span><span style="color: #C3E88D">Iván</span><span style="color: #89DDFF">"</span><span style="color: #89DDFF">,</span><span style="color: #FFFFFF"> </span><span style="color: #F78C6C">1</span><span style="color: #89DDFF">,</span><span style="color: #FFFFFF"> </span><span style="color: #F78C6C">1</span><span style="color: #89DDFF">,</span><span style="color: #FFFFFF"> </span><span style="color: #F78C6C">1990</span><span style="color: #89DDFF">);</span>
<span style="color: #FFFFFF">      </span><span style="color: #A6ACCD">Console</span><span style="color: #89DDFF">.</span><span style="color: #82AAFF">WriteLine</span><span style="color: #89DDFF">(</span><span style="color: #89DDFF">"</span><span style="color: #C3E88D">Person has </span><span style="color: #89DDFF">"</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">+</span><span style="color: #FFFFFF"> </span><span style="color: #A6ACCD">person</span><span style="color: #89DDFF">.</span><span style="color: #82AAFF">getAge</span><span style="color: #89DDFF">());</span>
<span style="color: #FFFFFF">   </span><span style="color: #89DDFF">}</span>
<span style="color: #89DDFF">}</span></code></pre>
...
<span style="color: #C792EA">public</span><span style="color: #FFFFFF"> </span><span style="color: #F78C6C">class</span><span style="color: #FFFFFF"> </span><span style="color: #FFCB6B">Dog</span><span style="color: #FFFFFF"> </span><span style="color: #89DDFF">{</span>
<span style="color: #FFFFFF">   </span><span style="color: #C792EA">private</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">string</span><span style="color: #FFFFFF"> </span><span style="color: #FFCB6B">name</span><span style="color: #89DDFF">;</span>
<span style="color: #FFFFFF">   </span><span style="color: #C792EA">private</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">int</span><span style="color: #FFFFFF"> </span><span style="color: #FFCB6B">bornDay</span><span style="color: #89DDFF">;</span>
<span style="color: #FFFFFF">   </span><span style="color: #C792EA">private</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">int</span><span style="color: #FFFFFF"> </span><span style="color: #FFCB6B">bornMonth</span><span style="color: #89DDFF">;</span>
<span style="color: #FFFFFF">   </span><span style="color: #C792EA">private</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">int</span><span style="color: #FFFFFF"> </span><span style="color: #FFCB6B">bornYear</span><span style="color: #89DDFF">;</span>

<span style="color: #FFFFFF">   </span><span style="color: #C792EA">public</span><span style="color: #FFFFFF"> </span><span style="color: #82AAFF">Dog</span><span style="color: #89DDFF">(</span><span style="color: #C792EA">string</span><span style="color: #FFFFFF"> </span><span style="color: #FFCB6B">name</span><span style="color: #89DDFF">,</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">int</span><span style="color: #FFFFFF"> </span><span style="color: #FFCB6B">bornDay</span><span style="color: #89DDFF">,</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">int</span><span style="color: #FFFFFF"> </span><span style="color: #FFCB6B">bornMonth</span><span style="color: #89DDFF">,</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">int</span><span style="color: #FFFFFF"> </span><span style="color: #FFCB6B">bornYear</span><span style="color: #89DDFF">)</span><span style="color: #FFFFFF"> </span><span style="color: #89DDFF">{</span>
<span style="color: #FFFFFF">      </span><span style="color: #F78C6C">this</span><span style="color: #89DDFF">.</span><span style="color: #A6ACCD">name</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">=</span><span style="color: #FFFFFF"> </span><span style="color: #A6ACCD">name</span><span style="color: #89DDFF">;</span>
<span style="color: #FFFFFF">      </span><span style="color: #F78C6C">this</span><span style="color: #89DDFF">.</span><span style="color: #A6ACCD">bornDay</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">=</span><span style="color: #FFFFFF"> </span><span style="color: #A6ACCD">bornDay</span><span style="color: #89DDFF">;</span>
<span style="color: #FFFFFF">      </span><span style="color: #F78C6C">this</span><span style="color: #89DDFF">.</span><span style="color: #A6ACCD">bornMonth</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">=</span><span style="color: #FFFFFF"> </span><span style="color: #A6ACCD">bornMonth</span><span style="color: #89DDFF">;</span>
<span style="color: #FFFFFF">      </span><span style="color: #F78C6C">this</span><span style="color: #89DDFF">.</span><span style="color: #A6ACCD">bornYear</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">=</span><span style="color: #FFFFFF"> </span><span style="color: #A6ACCD">bornYear</span><span style="color: #89DDFF">;</span>
...
<span style="color: #FFFFFF">   </span><span style="color: #C792EA">public</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">int</span><span style="color: #FFFFFF"> </span><span style="color: #82AAFF">getAge</span><span style="color: #89DDFF">()</span><span style="color: #FFFFFF"> </span><span style="color: #89DDFF">{</span>
<span style="color: #FFFFFF">      </span><span style="color: #89DDFF">if</span><span style="color: #FFFFFF"> </span><span style="color: #89DDFF">(</span><span style="color: #A6ACCD">nowMonth</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">&gt;=</span><span style="color: #FFFFFF"> </span><span style="color: #A6ACCD">bornMonth</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">&&</span><span style="color: #FFFFFF"> </span><span style="color: #A6ACCD">nowDay</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">&gt;=</span><span style="color: #FFFFFF"> </span><span style="color: #A6ACCD">bornDay</span><span style="color: #89DDFF">)</span><span style="color: #FFFFFF"> </span><span style="color: #89DDFF">{</span>
<span style="color: #FFFFFF">         </span><span style="color: #89DDFF">return</span><span style="color: #89DDFF">((</span><span style="color: #A6ACCD">nowYear</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">-</span><span style="color: #FFFFFF"> </span><span style="color: #A6ACCD">bornYear</span><span style="color: #89DDFF">)</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">*</span><span style="color: #FFFFFF"> </span><span style="color: #F78C6C">7</span><span style="color: #89DDFF">);</span>
<span style="color: #FFFFFF">      </span><span style="color: #89DDFF">}</span>
<span style="color: #FFFFFF">      </span><span style="color: #89DDFF">return</span><span style="color: #FFFFFF"> </span><span style="color: #89DDFF">((</span><span style="color: #A6ACCD">nowYear</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">-</span><span style="color: #FFFFFF"> </span><span style="color: #A6ACCD">bornYear</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">-</span><span style="color: #FFFFFF"> </span><span style="color: #F78C6C">1</span><span style="color: #89DDFF">)</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">*</span><span style="color: #FFFFFF"> </span><span style="color: #F78C6C">7</span><span style="color: #89DDFF">);</span>
<span style="color: #FFFFFF">   </span><span style="color: #89DDFF">}</span></code></pre>
<ul>
<li>Refactor a través de clase abstracta</li>
</ul>
<pre class="shiki" style="background-color: #292D3E"><code><span style="color: #C792EA">public</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">abstract</span><span style="color: #FFFFFF"> </span><span style="color: #F78C6C">class</span><span style="color: #FFFFFF"> </span><span style="color: #FFCB6B">LivingCreature</span><span style="color: #FFFFFF"> </span><span style="color: #89DDFF">{</span>
<span style="color: #FFFFFF">   </span><span style="color: #C792EA">private</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">string</span><span style="color: #FFFFFF"> </span><span style="color: #FFCB6B">name</span><span style="color: #89DDFF">;</span>
<span style="color: #FFFFFF">   </span><span style="color: #C792EA">private</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">int</span><span style="color: #FFFFFF"> </span><span style="color: #FFCB6B">bornDay</span><span style="color: #89DDFF">;</span>
<span style="color: #FFFFFF">   </span><span style="color: #C792EA">private</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">int</span><span style="color: #FFFFFF"> </span><span style="color: #FFCB6B">bornMonth</span><span style="color: #89DDFF">;</span>
<span style="color: #FFFFFF">   </span><span style="color: #C792EA">private</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">int</span><span style="color: #FFFFFF"> </span><span style="color: #FFCB6B">bornYear</span><span style="color: #89DDFF">;</span>

<span style="color: #FFFFFF">   </span><span style="color: #C792EA">public</span><span style="color: #FFFFFF"> </span><span style="color: #82AAFF">LivingCreature</span><span style="color: #89DDFF">(</span><span style="color: #C792EA">string</span><span style="color: #FFFFFF"> </span><span style="color: #FFCB6B">name</span><span style="color: #89DDFF">,</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">int</span><span style="color: #FFFFFF"> </span><span style="color: #FFCB6B">bornDay</span><span style="color: #89DDFF">,</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">int</span><span style="color: #FFFFFF"> </span><span style="color: #FFCB6B">bornMonth</span><span style="color: #89DDFF">,</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">int</span><span style="color: #FFFFFF"> </span><span style="color: #FFCB6B">bornYear</span><span style="color: #89DDFF">)</span><span style="color: #FFFFFF"> </span><span style="color: #89DDFF">{</span>
<span style="color: #FFFFFF">      </span><span style="color: #F78C6C">this</span><span style="color: #89DDFF">.</span><span style="color: #A6ACCD">name</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">=</span><span style="color: #FFFFFF"> </span><span style="color: #A6ACCD">name</span><span style="color: #89DDFF">;</span>
<span style="color: #FFFFFF">      </span><span style="color: #F78C6C">this</span><span style="color: #89DDFF">.</span><span style="color: #A6ACCD">bornDay</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">=</span><span style="color: #FFFFFF"> </span><span style="color: #A6ACCD">bornDay</span><span style="color: #89DDFF">;</span>
<span style="color: #FFFFFF">      </span><span style="color: #F78C6C">this</span><span style="color: #89DDFF">.</span><span style="color: #A6ACCD">bornMonth</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">=</span><span style="color: #FFFFFF"> </span><span style="color: #A6ACCD">bornMonth</span><span style="color: #89DDFF">;</span>
<span style="color: #FFFFFF">      </span><span style="color: #F78C6C">this</span><span style="color: #89DDFF">.</span><span style="color: #A6ACCD">bornYear</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">=</span><span style="color: #FFFFFF"> </span><span style="color: #A6ACCD">bornYear</span><span style="color: #89DDFF">;</span>
...
<span style="color: #FFFFFF">   </span><span style="color: #C792EA">public</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">virtual</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">int</span><span style="color: #FFFFFF"> </span><span style="color: #82AAFF">getAge</span><span style="color: #89DDFF">()</span><span style="color: #FFFFFF"> </span><span style="color: #89DDFF">{</span>
<span style="color: #FFFFFF">      </span><span style="color: #89DDFF">if</span><span style="color: #FFFFFF"> </span><span style="color: #89DDFF">(</span><span style="color: #A6ACCD">nowMonth</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">&gt;=</span><span style="color: #FFFFFF"> </span><span style="color: #A6ACCD">bornMonth</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">&&</span><span style="color: #FFFFFF"> </span><span style="color: #A6ACCD">nowDay</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">&gt;=</span><span style="color: #FFFFFF"> </span><span style="color: #A6ACCD">bornDay</span><span style="color: #89DDFF">)</span><span style="color: #FFFFFF"> </span><span style="color: #89DDFF">{</span>
<span style="color: #FFFFFF">         </span><span style="color: #89DDFF">return</span><span style="color: #FFFFFF"> </span><span style="color: #89DDFF">(</span><span style="color: #A6ACCD">nowYear</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">-</span><span style="color: #FFFFFF"> </span><span style="color: #A6ACCD">bornYear</span><span style="color: #89DDFF">);</span>
<span style="color: #FFFFFF">      </span><span style="color: #89DDFF">}</span>
<span style="color: #FFFFFF">      </span><span style="color: #89DDFF">return</span><span style="color: #FFFFFF"> </span><span style="color: #89DDFF">(</span><span style="color: #A6ACCD">nowYear</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">-</span><span style="color: #FFFFFF"> </span><span style="color: #A6ACCD">bornYear</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">-</span><span style="color: #FFFFFF"> </span><span style="color: #F78C6C">1</span><span style="color: #89DDFF">);</span>
...
<span style="color: #C792EA">public</span><span style="color: #FFFFFF"> </span><span style="color: #F78C6C">class</span><span style="color: #FFFFFF"> </span><span style="color: #FFCB6B">Person</span><span style="color: #FFFFFF"> </span><span style="color: #89DDFF">:</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">LivingCreature</span><span style="color: #FFFFFF"> </span><span style="color: #89DDFF">{</span>
<span style="color: #FFFFFF">   </span><span style="color: #C792EA">public</span><span style="color: #FFFFFF"> </span><span style="color: #82AAFF">Person</span><span style="color: #89DDFF">(</span><span style="color: #C792EA">string</span><span style="color: #FFFFFF"> </span><span style="color: #FFCB6B">name</span><span style="color: #89DDFF">,</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">int</span><span style="color: #FFFFFF"> </span><span style="color: #FFCB6B">bornDay</span><span style="color: #89DDFF">,</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">int</span><span style="color: #FFFFFF"> </span><span style="color: #FFCB6B">bornMonth</span><span style="color: #89DDFF">,</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">int</span><span style="color: #FFFFFF"> </span><span style="color: #FFCB6B">bornYear</span><span style="color: #89DDFF">)</span><span style="color: #FFFFFF"> </span><span style="color: #89DDFF">:</span>
<span style="color: #FFFFFF">      </span><span style="color: #F78C6C">base</span><span style="color: #89DDFF">(</span><span style="color: #A6ACCD">name</span><span style="color: #89DDFF">,</span><span style="color: #FFFFFF"> </span><span style="color: #A6ACCD">bornDay</span><span style="color: #89DDFF">,</span><span style="color: #FFFFFF"> </span><span style="color: #A6ACCD">bornMonth</span><span style="color: #89DDFF">,</span><span style="color: #FFFFFF"> </span><span style="color: #A6ACCD">bornYear</span><span style="color: #89DDFF">)</span><span style="color: #FFFFFF"> </span><span style="color: #89DDFF">{</span>
<span style="color: #FFFFFF">   </span><span style="color: #89DDFF">}</span>
<span style="color: #89DDFF">}</span>

<span style="color: #C792EA">public</span><span style="color: #FFFFFF"> </span><span style="color: #F78C6C">class</span><span style="color: #FFFFFF"> </span><span style="color: #FFCB6B">Dog</span><span style="color: #FFFFFF"> </span><span style="color: #89DDFF">:</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">LivingCreature</span><span style="color: #FFFFFF"> </span><span style="color: #89DDFF">{</span>
<span style="color: #FFFFFF">   </span><span style="color: #C792EA">public</span><span style="color: #FFFFFF"> </span><span style="color: #82AAFF">Dog</span><span style="color: #89DDFF">(</span><span style="color: #C792EA">string</span><span style="color: #FFFFFF"> </span><span style="color: #FFCB6B">name</span><span style="color: #89DDFF">,</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">int</span><span style="color: #FFFFFF"> </span><span style="color: #FFCB6B">bornDay</span><span style="color: #89DDFF">,</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">int</span><span style="color: #FFFFFF"> </span><span style="color: #FFCB6B">bornMonth</span><span style="color: #89DDFF">,</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">int</span><span style="color: #FFFFFF"> </span><span style="color: #FFCB6B">bornYear</span><span style="color: #89DDFF">)</span><span style="color: #FFFFFF"> </span><span style="color: #89DDFF">:</span>
<span style="color: #FFFFFF">      </span><span style="color: #F78C6C">base</span><span style="color: #89DDFF">(</span><span style="color: #A6ACCD">name</span><span style="color: #89DDFF">,</span><span style="color: #FFFFFF"> </span><span style="color: #A6ACCD">bornDay</span><span style="color: #89DDFF">,</span><span style="color: #FFFFFF"> </span><span style="color: #A6ACCD">bornMonth</span><span style="color: #89DDFF">,</span><span style="color: #FFFFFF"> </span><span style="color: #A6ACCD">bornYear</span><span style="color: #89DDFF">)</span><span style="color: #FFFFFF"> </span><span style="color: #89DDFF">{</span>
<span style="color: #FFFFFF">   </span><span style="color: #89DDFF">}</span>

<span style="color: #FFFFFF">   </span><span style="color: #C792EA">public</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">int</span><span style="color: #FFFFFF"> </span><span style="color: #82AAFF">getAge</span><span style="color: #89DDFF">()</span><span style="color: #FFFFFF"> </span><span style="color: #89DDFF">{</span>
<span style="color: #FFFFFF">      </span><span style="color: #89DDFF">return</span><span style="color: #FFFFFF"> </span><span style="color: #F78C6C">base</span><span style="color: #89DDFF">.</span><span style="color: #82AAFF">getAge</span><span style="color: #89DDFF">()</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">*</span><span style="color: #FFFFFF"> </span><span style="color: #F78C6C">7</span><span style="color: #89DDFF">;</span>
<span style="color: #FFFFFF">   </span><span style="color: #89DDFF">}</span>
<span style="color: #89DDFF">}</span></code></pre>
<ul>
<li>Refactor utilizando interfaz</li>
</ul>
<pre class="shiki" style="background-color: #292D3E"><code><span style="color: #C792EA">public</span><span style="color: #FFFFFF"> </span><span style="color: #F78C6C">interface</span><span style="color: #FFFFFF"> </span><span style="color: #FFCB6B">LivingCreatureDefaultAge</span><span style="color: #FFFFFF"> </span><span style="color: #89DDFF">{</span>
<span style="color: #FFFFFF">   public </span><span style="color: #C792EA">int</span><span style="color: #FFFFFF"> </span><span style="color: #82AAFF">getAge</span><span style="color: #89DDFF">(</span><span style="color: #C792EA">int</span><span style="color: #FFFFFF"> </span><span style="color: #FFCB6B">bornDay</span><span style="color: #89DDFF">,</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">int</span><span style="color: #FFFFFF"> </span><span style="color: #FFCB6B">bornMonth</span><span style="color: #89DDFF">,</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">int</span><span style="color: #FFFFFF"> </span><span style="color: #FFCB6B">bornYear</span><span style="color: #89DDFF">)</span><span style="color: #FFFFFF"> </span><span style="color: #89DDFF">{</span>
<span style="color: #FFFFFF">      </span><span style="color: #89DDFF">if</span><span style="color: #FFFFFF"> </span><span style="color: #89DDFF">(</span><span style="color: #F78C6C">05</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">&gt;=</span><span style="color: #FFFFFF"> </span><span style="color: #A6ACCD">bornMonth</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">&&</span><span style="color: #FFFFFF"> </span><span style="color: #F78C6C">03</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">&gt;=</span><span style="color: #FFFFFF"> </span><span style="color: #A6ACCD">bornDay</span><span style="color: #89DDFF">)</span><span style="color: #FFFFFF"> </span><span style="color: #89DDFF">{</span>
<span style="color: #FFFFFF">         </span><span style="color: #89DDFF">return</span><span style="color: #FFFFFF"> </span><span style="color: #89DDFF">(</span><span style="color: #F78C6C">2020</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">-</span><span style="color: #FFFFFF"> </span><span style="color: #A6ACCD">bornYear</span><span style="color: #89DDFF">);</span>
<span style="color: #FFFFFF">      </span><span style="color: #89DDFF">}</span>
<span style="color: #FFFFFF">      </span><span style="color: #89DDFF">return</span><span style="color: #FFFFFF"> </span><span style="color: #89DDFF">(</span><span style="color: #F78C6C">2020</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">-</span><span style="color: #FFFFFF"> </span><span style="color: #A6ACCD">bornYear</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">-</span><span style="color: #FFFFFF"> </span><span style="color: #F78C6C">1</span><span style="color: #89DDFF">);</span>
<span style="color: #FFFFFF">   </span><span style="color: #89DDFF">}</span>
<span style="color: #89DDFF">}</span>

<span style="color: #C792EA">public</span><span style="color: #FFFFFF"> </span><span style="color: #F78C6C">class</span><span style="color: #FFFFFF"> </span><span style="color: #FFCB6B">Person</span><span style="color: #FFFFFF"> </span><span style="color: #89DDFF">:</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">LivingCreatureDefaultAge</span><span style="color: #FFFFFF"> </span><span style="color: #89DDFF">{</span>
<span style="color: #FFFFFF">   </span><span style="color: #C792EA">private</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">string</span><span style="color: #FFFFFF"> </span><span style="color: #FFCB6B">name</span><span style="color: #89DDFF">;</span>
<span style="color: #FFFFFF">   </span><span style="color: #C792EA">private</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">int</span><span style="color: #FFFFFF"> </span><span style="color: #FFCB6B">bornDay</span><span style="color: #89DDFF">;</span>
<span style="color: #FFFFFF">   </span><span style="color: #C792EA">private</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">int</span><span style="color: #FFFFFF"> </span><span style="color: #FFCB6B">bornMonth</span><span style="color: #89DDFF">;</span>
<span style="color: #FFFFFF">   </span><span style="color: #C792EA">private</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">int</span><span style="color: #FFFFFF"> </span><span style="color: #FFCB6B">bornYear</span><span style="color: #89DDFF">;</span>
...
<span style="color: #FFFFFF">   </span><span style="color: #C792EA">public</span><span style="color: #FFFFFF"> </span><span style="color: #82AAFF">Person</span><span style="color: #89DDFF">(</span><span style="color: #C792EA">string</span><span style="color: #FFFFFF"> </span><span style="color: #FFCB6B">name</span><span style="color: #89DDFF">,</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">int</span><span style="color: #FFFFFF"> </span><span style="color: #FFCB6B">bornDay</span><span style="color: #89DDFF">,</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">int</span><span style="color: #FFFFFF"> </span><span style="color: #FFCB6B">bornMonth</span><span style="color: #89DDFF">,</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">int</span><span style="color: #FFFFFF"> </span><span style="color: #FFCB6B">bornYear</span><span style="color: #89DDFF">)</span><span style="color: #FFFFFF"> </span><span style="color: #89DDFF">{</span>
<span style="color: #FFFFFF">      </span><span style="color: #F78C6C">this</span><span style="color: #89DDFF">.</span><span style="color: #A6ACCD">name</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">=</span><span style="color: #FFFFFF"> </span><span style="color: #A6ACCD">name</span><span style="color: #89DDFF">;</span><span style="color: #FFFFFF">      </span>
<span style="color: #FFFFFF">      </span><span style="color: #F78C6C">this</span><span style="color: #89DDFF">.</span><span style="color: #A6ACCD">bornDay</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">=</span><span style="color: #FFFFFF"> </span><span style="color: #A6ACCD">bornDay</span><span style="color: #89DDFF">;</span>
<span style="color: #FFFFFF">      </span><span style="color: #F78C6C">this</span><span style="color: #89DDFF">.</span><span style="color: #A6ACCD">bornMonth</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">=</span><span style="color: #FFFFFF"> </span><span style="color: #A6ACCD">bornMonth</span><span style="color: #89DDFF">;</span>
<span style="color: #FFFFFF">      </span><span style="color: #F78C6C">this</span><span style="color: #89DDFF">.</span><span style="color: #A6ACCD">bornYear</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">=</span><span style="color: #FFFFFF"> </span><span style="color: #A6ACCD">bornYear</span><span style="color: #89DDFF">;</span>
<span style="color: #FFFFFF">   </span><span style="color: #89DDFF">}</span>
...
<span style="color: #FFFFFF">   </span><span style="color: #C792EA">public</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">int</span><span style="color: #FFFFFF"> </span><span style="color: #82AAFF">getAge</span><span style="color: #89DDFF">()</span><span style="color: #FFFFFF"> </span><span style="color: #89DDFF">{</span>
<span style="color: #FFFFFF">      </span><span style="color: #C792EA">LivingCreatureDefaultAge</span><span style="color: #FFFFFF"> </span><span style="color: #FFCB6B">livingCreatureDefaultAge</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">=</span><span style="color: #FFFFFF"> </span><span style="color: #F78C6C">this</span><span style="color: #89DDFF">;</span>
<span style="color: #FFFFFF">      </span><span style="color: #89DDFF">return</span><span style="color: #FFFFFF"> </span><span style="color: #A6ACCD">livingCreatureDefaultAge</span><span style="color: #89DDFF">.</span><span style="color: #82AAFF">getAge</span><span style="color: #89DDFF">(</span><span style="color: #A6ACCD">bornDay</span><span style="color: #89DDFF">,</span><span style="color: #FFFFFF"> </span><span style="color: #A6ACCD">bornMonth</span><span style="color: #89DDFF">,</span><span style="color: #FFFFFF"> </span><span style="color: #A6ACCD">bornYear</span><span style="color: #89DDFF">);</span>
<span style="color: #FFFFFF">   </span><span style="color: #89DDFF">}</span>
<span style="color: #89DDFF">}</span>

<span style="color: #C792EA">public</span><span style="color: #FFFFFF"> </span><span style="color: #F78C6C">class</span><span style="color: #FFFFFF"> </span><span style="color: #FFCB6B">Dog</span><span style="color: #FFFFFF"> </span><span style="color: #89DDFF">:</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">LivingCreatureDefaultAge</span><span style="color: #FFFFFF"> </span><span style="color: #89DDFF">{</span>
<span style="color: #FFFFFF">   </span><span style="color: #C792EA">private</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">string</span><span style="color: #FFFFFF"> </span><span style="color: #FFCB6B">name</span><span style="color: #89DDFF">;</span>
<span style="color: #FFFFFF">   </span><span style="color: #C792EA">private</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">int</span><span style="color: #FFFFFF"> </span><span style="color: #FFCB6B">bornDay</span><span style="color: #89DDFF">;</span>
<span style="color: #FFFFFF">   </span><span style="color: #C792EA">private</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">int</span><span style="color: #FFFFFF"> </span><span style="color: #FFCB6B">bornMonth</span><span style="color: #89DDFF">;</span>
<span style="color: #FFFFFF">   </span><span style="color: #C792EA">private</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">int</span><span style="color: #FFFFFF"> </span><span style="color: #FFCB6B">bornYear</span><span style="color: #89DDFF">;</span>
...
<pre class="shiki" style="background-color: #292D3E"><code><span style="color: #C792EA">public</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">abstract</span><span style="color: #FFFFFF"> </span><span style="color: #F78C6C">class</span><span style="color: #FFFFFF"> </span><span style="color: #FFCB6B">LivingCreature</span><span style="color: #FFFFFF"> </span><span style="color: #89DDFF">{</span>
<span style="color: #FFFFFF">   </span><span style="color: #C792EA">protected</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">string</span><span style="color: #FFFFFF"> </span><span style="color: #FFCB6B">name</span><span style="color: #89DDFF">;</span>
<span style="color: #FFFFFF">   </span><span style="color: #C792EA">private</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">int</span><span style="color: #FFFFFF"> </span><span style="color: #FFCB6B">bornDay</span><span style="color: #89DDFF">;</span>
<span style="color: #FFFFFF">   </span><span style="color: #C792EA">private</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">int</span><span style="color: #FFFFFF"> </span><span style="color: #FFCB6B">bornMonth</span><span style="color: #89DDFF">;</span>
<span style="color: #FFFFFF">   </span><span style="color: #C792EA">private</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">int</span><span style="color: #FFFFFF"> </span><span style="color: #FFCB6B">bornYear</span><span style="color: #89DDFF">;</span>
...
<span style="color: #C792EA">public</span><span style="color: #FFFFFF"> </span><span style="color: #F78C6C">class</span><span style="color: #FFFFFF"> </span><span style="color: #FFCB6B">Person</span><span style="color: #FFFFFF"> </span><span style="color: #89DDFF">:</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">LivingCreature</span><span style="color: #FFFFFF"> </span><span style="color: #89DDFF">{</span>
<span style="color: #FFFFFF">    </span><span style="color: #C792EA">private</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">string</span><span style="color: #FFFFFF"> </span><span style="color: #FFCB6B">surname</span><span style="color: #89DDFF">;</span>

<span style="color: #FFFFFF">    </span><span style="color: #C792EA">public</span><span style="color: #FFFFFF"> </span><span style="color: #82AAFF">Person</span><span style="color: #89DDFF">(</span><span style="color: #C792EA">string</span><span style="color: #FFFFFF"> </span><span style="color: #FFCB6B">name</span><span style="color: #89DDFF">,</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">string</span><span style="color: #FFFFFF"> </span><span style="color: #FFCB6B">surname</span><span style="color: #89DDFF">,</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">int</span><span style="color: #FFFFFF"> </span><span style="color: #FFCB6B">bornDay</span><span style="color: #89DDFF">,</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">int</span><span style="color: #FFFFFF"> </span><span style="color: #FFCB6B">bornMonth</span><span style="color: #89DDFF">,</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">int</span><span style="color: #FFFFFF"> </span><span style="color: #FFCB6B">bornYear</span><span style="color: #89DDFF">)</span><span style="color: #FFFFFF"> </span><span style="color: #89DDFF">:</span>
<span style="color: #FFFFFF">        </span><span style="color: #F78C6C">base</span><span style="color: #89DDFF">(</span><span style="color: #A6ACCD">name</span><span style="color: #89DDFF">,</span><span style="color: #FFFFFF"> </span><span style="color: #A6ACCD">bornDay</span><span style="color: #89DDFF">,</span><span style="color: #FFFFFF"> </span><span style="color: #A6ACCD">bornMonth</span><span style="color: #89DDFF">,</span><span style="color: #FFFFFF"> </span><span style="color: #A6ACCD">bornYear</span><span style="color: #89DDFF">)</span><span style="color: #FFFFFF"> </span><span style="color: #89DDFF">{</span>
<span style="color: #FFFFFF">        </span><span style="color: #F78C6C">this</span><span style="color: #89DDFF">.</span><span style="color: #A6ACCD">surname</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">=</span><span style="color: #FFFFFF"> </span><span style="color: #A6ACCD">surname</span><span style="color: #89DDFF">;</span>
<span style="color: #FFFFFF">    </span><span style="color: #89DDFF">}</span>

<span style="color: #FFFFFF">    </span><span style="color: #C792EA">public</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">string</span><span style="color: #FFFFFF"> </span><span style="color: #82AAFF">getNameAndSurname</span><span style="color: #89DDFF">()</span><span style="color: #FFFFFF"> </span><span style="color: #89DDFF">{</span>
<span style="color: #FFFFFF">        </span><span style="color: #89DDFF">return</span><span style="color: #FFFFFF"> </span><span style="color: #F78C6C">base</span><span style="color: #89DDFF">.</span><span style="color: #A6ACCD">name</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">+</span><span style="color: #FFFFFF"> </span><span style="color: #89DDFF">'</span><span style="color: #C3E88D"> </span><span style="color: #89DDFF">'</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">+</span><span style="color: #FFFFFF"> </span><span style="color: #F78C6C">this</span><span style="color: #89DDFF">.</span><span style="color: #A6ACCD">surname</span><span style="color: #89DDFF">;</span>
<span style="color: #FFFFFF">    </span><span style="color: #89DDFF">}</span>
<span style="color: #89DDFF">}</span>

<span style="color: #F78C6C">class</span><span style="color: #FFFFFF"> </span><span style="color: #FFCB6B">Init</span><span style="color: #FFFFFF"> </span><span style="color: #89DDFF">{</span>
<span style="color: #FFFFFF">   </span><span style="color: #C792EA">private</span><span style="color: #FFFFFF"> </span><span style="color: #82AAFF">Init</span><span style="color: #89DDFF">()</span><span style="color: #FFFFFF"> </span><span style="color: #89DDFF">{</span>
<span style="color: #FFFFFF">      </span><span style="color: #F78C6C">var</span><span style="color: #FFFFFF"> </span><span style="color: #FFCB6B">person</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">=</span><span style="color: #FFFFFF"> </span><span style="color: #F78C6C">new</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">Person</span><span style="color: #89DDFF">(</span><span style="color: #89DDFF">"</span><span style="color: #C3E88D">Iván</span><span style="color: #89DDFF">"</span><span style="color: #89DDFF">,</span><span style="color: #FFFFFF"> </span><span style="color: #89DDFF">"</span><span style="color: #C3E88D">Santos</span><span style="color: #89DDFF">"</span><span style="color: #89DDFF">,</span><span style="color: #FFFFFF"> </span><span style="color: #F78C6C">12</span><span style="color: #89DDFF">,</span><span style="color: #FFFFFF"> </span><span style="color: #F78C6C">1</span><span style="color: #89DDFF">,</span><span style="color: #FFFFFF"> </span><span style="color: #F78C6C">1990</span><span style="color: #89DDFF">);</span>
<span style="color: #FFFFFF">      </span><span style="color: #A6ACCD">Console</span><span style="color: #89DDFF">.</span><span style="color: #82AAFF">WriteLine</span><span style="color: #89DDFF">(</span><span style="color: #89DDFF">"</span><span style="color: #C3E88D">Person has </span><span style="color: #89DDFF">"</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">+</span><span style="color: #FFFFFF"> </span><span style="color: #A6ACCD">person</span><span style="color: #89DDFF">.</span><span style="color: #82AAFF">getAge</span><span style="color: #89DDFF">());</span>

<span style="color: #FFFFFF">			</span><span style="color: #F78C6C">var</span><span style="color: #FFFFFF"> </span><span style="color: #FFCB6B">livingCreature</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">=</span><span style="color: #FFFFFF"> </span><span style="color: #F78C6C">new</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">LivingCreature</span><span style="color: #89DDFF">(</span><span style="color: #89DDFF">"</span><span style="color: #C3E88D">Iván</span><span style="color: #89DDFF">"</span><span style="color: #89DDFF">,</span><span style="color: #FFFFFF"> </span><span style="color: #F78C6C">12</span><span style="color: #89DDFF">,</span><span style="color: #FFFFFF"> </span><span style="color: #F78C6C">1</span><span style="color: #89DDFF">,</span><span style="color: #FFFFFF"> </span><span style="color: #F78C6C">1990</span><span style="color: #89DDFF">);</span>
<span style="color: #FFFFFF">      </span><span style="color: #A6ACCD">Console</span><span style="color: #89DDFF">.</span><span style="color: #82AAFF">WriteLine</span><span style="color: #89DDFF">(</span><span style="color: #89DDFF">"</span><span style="color: #C3E88D">livingCreature has </span><span style="color: #89DDFF">"</span><span style="color: #FFFFFF"> </span><span style="color: #C792EA">+</span><span style="color: #FFFFFF"> </span><span style="color: #A6ACCD">livingCreature</span><span style="color: #89DDFF">.</span><span style="color: #82AAFF">getAge</span><span style="color: #89DDFF">());</span>
<span style="color: #FFFFFF">   </span><span style="color: #89DDFF">}</span>
<span style="color: #89DDFF">}</span>
...
<p><img class="g-image g-image--lazy g-image--loading" src="data:image/svg+xml,%3csvg fill='none' viewBox='0 0 860 782' xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink'%3e%3cdefs%3e%3cfilter id='__svg-blur-d15eac7ff67b2ca0bb8709543870cf9f'%3e%3cfeGaussianBlur in='SourceGraphic' stdDeviation='40'/%3e%3c/filter%3e%3c/defs%3e%3cimage x='0' y='0' filter='url(%23__svg-blur-d15eac7ff67b2ca0bb8709543870cf9f)' width='860' height='782' xlink:href='data:image/png%3bbase64%2ciVBORw0KGgoAAAANSUhEUgAAAEAAAAA6CAYAAAAA0F95AAAACXBIWXMAAAsSAAALEgHS3X78AAAHdElEQVRo3t2b104kOxCG53m54AV4E%2b6RuOICCQQCRM5Lzjmn3SXn2EefpX9U43GHAWYPPZZK3dN2l8u/q8rlck8hqlL5%2bPj4kbz8Uqjm4M/OzqL%2b/v5ocnIyGh8fz0wTExPuOjY2Fj0%2bPlYVhKoA8P7%2b7q6rq6vR5uamu396eoqen59L6PX11bX16/jNgGdnZ6PT09P8ArCxsREdHh4G2zDQvb294gBDBQDRolwDcHBwEBwAsw8A%2b/v7ZfW6X1lZyTcAzODOzo67f3t7c88h3avYOtVTFhYW8m0Cx8fHUW9vb/Tr168S54ZT5Flra2vU1dUVTU1NFeu4ioaHh6OHh4f8ARBSaRGFQV1eXkZXV1fR%2bfl5dHNz40wi1DbXy2BoMHd3d9H19bW7Z4nD46MxPOM%2bDrTcaIAvtO6x64uLCweACppg13k0As0IvZ8LAOIElsrLuVlT8AMdlkeA4poE6I8DIE5I7BsK1fsAWG0BsNvb21T%2bPwKAkHDYMw7Ot%2bs0DQhpju8gv9MkCtVQ%2bfv7e%2bfUtBzGqXGcBtj7l5cXB4Lafbc2FL5z1hlwFtVN04AQqJgRTjIO1H8GQNxMoeoIGKeuoXU9BEDSuzhGNAut%2bC4HWfgOldfanmX5SjOBOB5Wy%2bgrq4OMi0l0LVQ6cASw9smSVal96jnA2VA3CQAfTPpE46w2JJlH3KQUQp3Gkd3A4OgQQGt7SNAkXgLTV%2bcsIPgTIBDtBIX4hfgUKo23//z547aodnmjDAwMFJ9ltcempqZobm4uWMdGiMHFaYAt9MuuUVvnUGGy4OlrcSG05NBYxG8IL8zurr6%2b3qWqFLFhj3Q%2bNDRU5tDQDvGwV%2bID3m9paXG7PgYAL9tucHDQ3fuA0odtJxNkd1lXV%2bdyDPgHyQ1hamtra9H09HSZthWsarMd7e7uLm5PIbauIvJ7CDYzM%2bNAsG14p729vWSvTz6gra3NtbdbXeUIecfmC1XPPZrBu4Blt9g8Gx0dLeNF%2bowZ7uvrKz6z/Bg87zGGEhOw6NLI2lOlhY6tQySjg9Z8tiwtLRXf10SNjIx8KXADDPu7BABm5O/fv0VzoJycnDj1XlxcLM4a1%2b3tbScQ675mHa1QQlMA0E4pMLVjYMyGNIv3lBqjnWIJPykKoYHwUZvl5WWnLQCDGcCP39wz%2b3qffnHc9BWrAaiq3a7a/J2IzgWOX%2bjUOkdM4OjoKNgW34G2wA/BfKcqDWACrAYAnD%2brkgn58C0CSCDZFQJQyjRA9gVzQCCRycyRz4NwLD7t7u4W6yHad3Z2OkEEKANgxgDB8uNdZlx8xFNtuCID/kieXTLiZ3xeIdnsPe25RyPxEWUaIOZSH1LZYsLVZ%2bg/0/Oenh6HujUBQGUWbXv4M0BLAkS8aMPS%2bvv375KVBVDi5AnJpHv4r6%2bvO3OONQHsHHX8bMFmUUHxIy3u5/2pRyMQBqE0iyFnSRubFmei8EFfKWi4jStKAJifny8JPhCWWUQQwIH4zZqK89HsKLBAOAuABqmYgOeYCADwnDUapwsfABAfRZf0YQGQFxcYas8VIAEcDWYi1K/aKWASgEENIA%2bPULYBARDPcFqAA2OCEASTtthVxAdAByMSgiCFfjgyg7a2thygACtHqLYhAOTEQiExIHIlWoXszlTaVxEAFOwHIRkMCKOu0gI/8ssCAKChAQjIFVunT4RXDFIpALJ32uN4cXqMxfcfFQMgUtgJQ2ya6EwHm2kAWFWkIBymxBUNkFnRN6B8BgDkwdFiTpgCv%2bnXJlYzAYAwir9tQa1AGYHtrIYcjO8EQ4ej2lAhMDMPheIA/3BUAFgfoG01MqGV2L/k9E2K3/5%2boGQZZAB0KAeIbSmwsFthBRzUW9ImyS6DOh63R%2bJoEwJSp1WAWaMftQtFgshgQ9nPHNkRrMUGQswYISUdg5QItcG7ss43NzeX1QOcQk%2bLODZOIMS7tj3vY6u8x2/UP8STGMJ3tGx46AeZRPQdIluvzRD9JOYDrHpZ0hLW0NDgBLanun6yxM8H2DZc5Z0bGxuLoa0CqDR%2bPMf5fpbKUmJZs6u2jfbYSamzJH4aHNrBChPXtlqHpCWBUCUprNChRVr6O4mfZr6SvtPSdlkoaAKfSYVjEn4qPMtsJSVF/3X5clpcXj0puRkHAIOv9gcQVTkYCam9zc6m%2bZW0g5EfDUDa8ZU%2bfkjK5uYegLQDT/xC0qFGrk0g69E4fsHfK4S%2bFcqtBqSBgHPEL8QdZNYUAEl%2bAXOw4WxNakAaCCRBQqe5NQdAknO0n8fZaLLmAEj62EFngDY7FPo%2bIC0Mzw0Aod0dO0gSIfos3qbBQsfxuQQgi8D6kCrulKkSXj8OAM02aSqSKDpPtB9CcwjT0dHhDipCH0pDHIxo253Lr8VJiZFl0rk%2bKg9hBsr920/kVa/EBVmhmvnHiM3oMLvUkcQk8cmBjD1Bqpk/TDBIne7aQgJUJ0LcM0h/iQwdjeUOAPL6JCMZHANhwJA%2bh9EnLrqqnrY8I0GbSwDsgQUOECB0tgiRVA2RbQNhGv7hRs0sg/8XL7/8B1efjrW2wWRQAAAAAElFTkSuQmCC' /%3e%3c/svg%3e" width="860" alt="Solid" data-srcset="/assets/static/isp1.82a2fbd.ea019427783c039ab99154aac52947ad.png 480w, /assets/static/isp1.bf9604d.ea019427783c039ab99154aac52947ad.png 860w" data-sizes="(max-width: 860px) 100vw, 860px" data-src="/assets/static/isp1.bf9604d.ea019427783c039ab99154aac52947ad.png"><noscript><img class="g-image g-image--lazy g-image--loaded" src="/assets/static/isp1.bf9604d.ea019427783c039ab99154aac52947ad.png" width="860" alt="Solid"></noscript></p>
    ...
    <script src="/assets/js/app.efe258bf.js" defer></script><script src="/assets/js/page--src-templates-post-vue.b8c2ff3f.js" defer></script>
  </body>
</html>
